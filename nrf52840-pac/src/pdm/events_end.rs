...
#[doc = "Field `EVENTS_END` reader - The PDM has written the last sample specified by SAMPLE.MAXCNT (or the last sample after a STOP task has been received) to Data RAM"]
...
#[doc = "Field `EVENTS_END` writer - The PDM has written the last sample specified by SAMPLE.MAXCNT (or the last sample after a STOP task has been received) to Data RAM"]
pub type EVENTS_END_W<'a, const O: u8> = crate::BitWriter<'a, EVENTS_END_SPEC, O, EVENTS_END_A>;
