...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, DIN_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, DIN_SPEC, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, DIN_SPEC, O, CONNECT_A>;
...
#[doc = "`reset()` method sets DIN to value 0xffff_ffff"]
