...
pub type CRCERROR_W<'a, const O: u8> = crate::BitWriter1C<'a, RX_SPEC, O, CRCERROR_A>;
...
pub type PARITYSTATUS_W<'a, const O: u8> = crate::BitWriter1C<'a, RX_SPEC, O, PARITYSTATUS_A>;
...
pub type OVERRUN_W<'a, const O: u8> = crate::BitWriter1C<'a, RX_SPEC, O, OVERRUN_A>;
