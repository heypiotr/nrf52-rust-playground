...
#[doc = "Field `EVENTS_READY` reader - The NFCT peripheral is ready to receive and send frames"]
...
#[doc = "Field `EVENTS_READY` writer - The NFCT peripheral is ready to receive and send frames"]
