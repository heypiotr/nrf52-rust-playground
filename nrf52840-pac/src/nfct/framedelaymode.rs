...
pub type FRAMEDELAYMODE_R = crate::FieldReader<FRAMEDELAYMODE_A>;
...
impl crate::FieldSpec for FRAMEDELAYMODE_A {
    type Ux = u8;
}
...
pub type FRAMEDELAYMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, FRAMEDELAYMODE_SPEC, 2, O, FRAMEDELAYMODE_A>;
