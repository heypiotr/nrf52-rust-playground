...
pub type READY_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, READY_A>;
...
pub type FIELDDETECTED_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, FIELDDETECTED_A>;
...
pub type FIELDLOST_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, FIELDLOST_A>;
...
pub type TXFRAMESTART_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, TXFRAMESTART_A>;
...
pub type TXFRAMEEND_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, TXFRAMEEND_A>;
...
pub type RXFRAMESTART_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, RXFRAMESTART_A>;
...
pub type RXFRAMEEND_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, RXFRAMEEND_A>;
...
pub type ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, ERROR_A>;
...
pub type RXERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, RXERROR_A>;
...
pub type ENDRX_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, ENDRX_A>;
...
pub type ENDTX_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, ENDTX_A>;
...
pub type AUTOCOLRESSTARTED_W<'a, const O: u8> =
    crate::BitWriter<'a, INTEN_SPEC, O, AUTOCOLRESSTARTED_A>;
...
pub type COLLISION_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, COLLISION_A>;
...
pub type SELECTED_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, SELECTED_A>;
