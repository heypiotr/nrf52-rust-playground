...
pub type TASKS_GOSLEEP_W<'a, const O: u8> =
    crate::BitWriter<'a, TASKS_GOSLEEP_SPEC, O, TASKS_GOSLEEP_AW>;
impl<'a, const O: u8> TASKS_GOSLEEP_W<'a, O> {
    #[doc = "Trigger task"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tasks_gosleep(&mut self) -> TASKS_GOSLEEP_W<0> {
        TASKS_GOSLEEP_W::new(self)
    }
