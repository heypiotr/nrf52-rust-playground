...
pub type FIELDDETECTED_ACTIVATE_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, FIELDDETECTED_ACTIVATE_A>;
...
pub type FIELDLOST_SENSE_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, FIELDLOST_SENSE_A>;
...
pub type TXFRAMEEND_ENABLERXDATA_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, TXFRAMEEND_ENABLERXDATA_A>;
