...
pub type TXDATABITS_R = crate::FieldReader;
...
pub type TXDATABITS_W<'a, const O: u8> = crate::FieldWriter<'a, AMOUNT_SPEC, 3, O>;
...
pub type TXDATABYTES_R = crate::FieldReader<u16>;
...
pub type TXDATABYTES_W<'a, const O: u8> = crate::FieldWriter<'a, AMOUNT_SPEC, 9, O, u16>;
impl R {
