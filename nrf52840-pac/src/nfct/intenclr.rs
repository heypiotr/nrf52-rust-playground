...
pub type FIELDDETECTED_W<'a, const O: u8> =
    crate::BitWriter<'a, INTENCLR_SPEC, O, FIELDDETECTED_AW>;
...
pub type FIELDLOST_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, FIELDLOST_AW>;
...
pub type TXFRAMESTART_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, TXFRAMESTART_AW>;
...
pub type TXFRAMEEND_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, TXFRAMEEND_AW>;
...
pub type RXFRAMESTART_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, RXFRAMESTART_AW>;
...
pub type RXFRAMEEND_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, RXFRAMEEND_AW>;
...
pub type ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ERROR_AW>;
...
pub type RXERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, RXERROR_AW>;
...
pub type ENDRX_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ENDRX_AW>;
...
pub type ENDTX_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ENDTX_AW>;
...
pub type AUTOCOLRESSTARTED_W<'a, const O: u8> =
    crate::BitWriter<'a, INTENCLR_SPEC, O, AUTOCOLRESSTARTED_AW>;
...
pub type COLLISION_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, COLLISION_AW>;
...
pub type SELECTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, SELECTED_AW>;
