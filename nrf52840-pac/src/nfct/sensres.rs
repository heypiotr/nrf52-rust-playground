...
pub type BITFRAMESDD_R = crate::FieldReader<BITFRAMESDD_A>;
...
impl crate::FieldSpec for BITFRAMESDD_A {
    type Ux = u8;
}
impl BITFRAMESDD_R {
...
pub type BITFRAMESDD_W<'a, const O: u8> = crate::FieldWriter<'a, SENSRES_SPEC, 5, O, BITFRAMESDD_A>;
...
impl crate::FieldSpec for NFCIDSIZE_A {
    type Ux = u8;
}
impl NFCIDSIZE_R {
    #[doc = "Get enumerated values variant"]
...
pub type NFCIDSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, SENSRES_SPEC, 2, O, NFCIDSIZE_A>;
...
pub type PLATFCONFIG_R = crate::FieldReader;
...
pub type PLATFCONFIG_W<'a, const O: u8> = crate::FieldWriter<'a, SENSRES_SPEC, 4, O>;
#[doc = "Field `RFU74` reader - Reserved for future use. Shall be 0."]
pub type RFU74_R = crate::FieldReader;
#[doc = "Field `RFU74` writer - Reserved for future use. Shall be 0."]
pub type RFU74_W<'a, const O: u8> = crate::FieldWriter<'a, SENSRES_SPEC, 4, O>;
impl R {
