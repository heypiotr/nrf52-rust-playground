...
#[doc = "Field `TASKS_START` writer - Task starting the random number generator"]
pub type TASKS_START_W<'a, const O: u8> = crate::BitWriter<'a, TASKS_START_SPEC, O, TASKS_START_AW>;
...
impl W {
    #[doc = "Bit 0 - Task starting the random number generator"]
    #[inline(always)]
    #[must_use]
