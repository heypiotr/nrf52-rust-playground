...
pub type TICK_W<'a, const O: u8> = crate::BitWriter<'a, EVTENSET_SPEC, O, TICK_AW>;
...
pub type OVRFLW_W<'a, const O: u8> = crate::BitWriter<'a, EVTENSET_SPEC, O, OVRFLW_AW>;
...
pub type COMPARE0_W<'a, const O: u8> = crate::BitWriter<'a, EVTENSET_SPEC, O, COMPARE0_AW>;
...
pub type COMPARE1_W<'a, const O: u8> = crate::BitWriter<'a, EVTENSET_SPEC, O, COMPARE1_AW>;
...
pub type COMPARE2_W<'a, const O: u8> = crate::BitWriter<'a, EVTENSET_SPEC, O, COMPARE2_AW>;
...
pub type COMPARE3_W<'a, const O: u8> = crate::BitWriter<'a, EVTENSET_SPEC, O, COMPARE3_AW>;
