...
pub type TICK_W<'a, const O: u8> = crate::BitWriter<'a, EVTEN_SPEC, O, TICK_A>;
...
pub type OVRFLW_W<'a, const O: u8> = crate::BitWriter<'a, EVTEN_SPEC, O, OVRFLW_A>;
...
pub type COMPARE0_W<'a, const O: u8> = crate::BitWriter<'a, EVTEN_SPEC, O, COMPARE0_A>;
...
pub type COMPARE1_W<'a, const O: u8> = crate::BitWriter<'a, EVTEN_SPEC, O, COMPARE1_A>;
...
pub type COMPARE2_W<'a, const O: u8> = crate::BitWriter<'a, EVTEN_SPEC, O, COMPARE2_A>;
...
pub type COMPARE3_W<'a, const O: u8> = crate::BitWriter<'a, EVTEN_SPEC, O, COMPARE3_A>;
