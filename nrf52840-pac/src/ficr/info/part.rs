...
pub type PART_R = crate::FieldReader<PART_A>;
...
impl crate::FieldSpec for PART_A {
    type Ux = u32;
}
impl PART_R {
...
#[doc = "`reset()` method sets PART to value 0x0005_2840"]
impl crate::Resettable for PART_SPEC {
    const RESET_VALUE: Self::Ux = 0x0005_2840;
}
