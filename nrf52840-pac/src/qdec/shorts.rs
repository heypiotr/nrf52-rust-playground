...
pub type REPORTRDY_READCLRACC_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, REPORTRDY_READCLRACC_A>;
...
pub type SAMPLERDY_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, SAMPLERDY_STOP_A>;
...
pub type REPORTRDY_RDCLRACC_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, REPORTRDY_RDCLRACC_A>;
...
pub type REPORTRDY_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, REPORTRDY_STOP_A>;
...
pub type DBLRDY_RDCLRDBL_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, DBLRDY_RDCLRDBL_A>;
...
pub type DBLRDY_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, DBLRDY_STOP_A>;
...
pub type SAMPLERDY_READCLRACC_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, SAMPLERDY_READCLRACC_A>;
