...
#[doc = "Field `ENABLE` reader - Enable or disable the quadrature decoder"]
...
#[doc = "Field `ENABLE` writer - Enable or disable the quadrature decoder"]
...
impl R {
    #[doc = "Bit 0 - Enable or disable the quadrature decoder"]
    #[inline(always)]
