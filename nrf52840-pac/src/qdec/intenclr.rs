...
pub type SAMPLERDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, SAMPLERDY_AW>;
...
pub type REPORTRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, REPORTRDY_AW>;
...
pub type ACCOF_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ACCOF_AW>;
...
pub type DBLRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, DBLRDY_AW>;
