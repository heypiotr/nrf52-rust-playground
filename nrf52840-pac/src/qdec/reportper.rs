...
pub type REPORTPER_R = crate::FieldReader<REPORTPER_A>;
...
impl crate::FieldSpec for REPORTPER_A {
    type Ux = u8;
}
impl REPORTPER_R {
...
pub type REPORTPER_W<'a, const O: u8> = crate::FieldWriter<'a, REPORTPER_SPEC, 4, O, REPORTPER_A>;
