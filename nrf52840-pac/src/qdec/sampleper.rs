...
pub type SAMPLEPER_R = crate::FieldReader<SAMPLEPER_A>;
...
impl crate::FieldSpec for SAMPLEPER_A {
    type Ux = u8;
}
impl SAMPLEPER_R {
...
pub type SAMPLEPER_W<'a, const O: u8> = crate::FieldWriter<'a, SAMPLEPER_SPEC, 4, O, SAMPLEPER_A>;
