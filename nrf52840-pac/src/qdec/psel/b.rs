#[doc = "Register `B` reader"]
pub struct R(crate::R<B_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<B_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<B_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `B` writer"]
pub struct W(crate::W<B_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<B_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<B_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, B_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, B_SPEC, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, B_SPEC, O, CONNECT_A>;
...
#[doc = "Pin select for B signal\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [b](index.html) module"]
pub struct B_SPEC;
impl crate::RegisterSpec for B_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [b::R](R) reader structure"]
impl crate::Readable for B_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [b::W](W) writer structure"]
impl crate::Writable for B_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets B to value 0xffff_ffff"]
