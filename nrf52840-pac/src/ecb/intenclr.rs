...
pub type ENDECB_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ENDECB_AW>;
...
pub type ERRORECB_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ERRORECB_AW>;
