...
#[doc = "Field `EVENTS_STOPPED` reader - SPI transaction has stopped"]
...
#[doc = "Field `EVENTS_STOPPED` writer - SPI transaction has stopped"]
pub type EVENTS_STOPPED_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_STOPPED_SPEC, O, EVENTS_STOPPED_A>;
