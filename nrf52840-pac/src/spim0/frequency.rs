...
pub type FREQUENCY_R = crate::FieldReader<FREQUENCY_A>;
...
impl crate::FieldSpec for FREQUENCY_A {
    type Ux = u32;
}
impl FREQUENCY_R {
    ...
    pub fn variant(&self) -> Option<FREQUENCY_A> {
        match self.bits {
            ...
            167772160 => Some(FREQUENCY_A::M16),
            335544320 => Some(FREQUENCY_A::M32),
            _ => None,
        }
    }
...
pub type FREQUENCY_W<'a, const O: u8> = crate::FieldWriter<'a, FREQUENCY_SPEC, 32, O, FREQUENCY_A>;
