#[doc = "Register `PSELDCX` reader"]
pub struct R(crate::R<PSELDCX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PSELDCX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PSELDCX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PSELDCX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PSELDCX` writer"]
pub struct W(crate::W<PSELDCX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PSELDCX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PSELDCX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PSELDCX_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, PSELDCX_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, PSELDCX_SPEC, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, PSELDCX_SPEC, O, CONNECT_A>;
...
#[doc = "Pin select for DCX signal\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pseldcx](index.html) module"]
pub struct PSELDCX_SPEC;
impl crate::RegisterSpec for PSELDCX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pseldcx::R](R) reader structure"]
impl crate::Readable for PSELDCX_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pseldcx::W](W) writer structure"]
impl crate::Writable for PSELDCX_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PSELDCX to value 0xffff_ffff"]
impl crate::Resettable for PSELDCX_SPEC {
