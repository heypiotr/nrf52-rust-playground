...
#[doc = "Field `TASKS_STOP` writer - Stops I2S transfer. Also stops MCK generator. Triggering this task will cause the STOPPED event to be generated."]
pub type TASKS_STOP_W<'a, const O: u8> = crate::BitWriter<'a, TASKS_STOP_SPEC, O, TASKS_STOP_AW>;
...
impl W {
    #[doc = "Bit 0 - Stops I2S transfer. Also stops MCK generator. Triggering this task will cause the STOPPED event to be generated."]
    #[inline(always)]
    #[must_use]
