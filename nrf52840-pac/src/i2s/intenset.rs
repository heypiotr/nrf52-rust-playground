...
pub type RXPTRUPD_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, RXPTRUPD_AW>;
...
pub type TXPTRUPD_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, TXPTRUPD_AW>;
