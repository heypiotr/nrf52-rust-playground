#[doc = "Register `SDIN` reader"]
pub struct R(crate::R<SDIN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SDIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SDIN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SDIN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SDIN` writer"]
pub struct W(crate::W<SDIN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SDIN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SDIN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SDIN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, SDIN_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, SDIN_SPEC, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, SDIN_SPEC, O, CONNECT_A>;
...
#[doc = "Pin select for SDIN signal.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sdin](index.html) module"]
pub struct SDIN_SPEC;
impl crate::RegisterSpec for SDIN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sdin::R](R) reader structure"]
impl crate::Readable for SDIN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sdin::W](W) writer structure"]
impl crate::Writable for SDIN_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SDIN to value 0xffff_ffff"]
impl crate::Resettable for SDIN_SPEC {
