#[doc = "Register `MCK` reader"]
pub struct R(crate::R<MCK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MCK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MCK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MCK` writer"]
pub struct W(crate::W<MCK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MCK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MCK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, MCK_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, MCK_SPEC, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, MCK_SPEC, O, CONNECT_A>;
...
#[doc = "Pin select for MCK signal.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mck](index.html) module"]
pub struct MCK_SPEC;
impl crate::RegisterSpec for MCK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mck::R](R) reader structure"]
impl crate::Readable for MCK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mck::W](W) writer structure"]
impl crate::Writable for MCK_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MCK to value 0xffff_ffff"]
impl crate::Resettable for MCK_SPEC {
