...
pub type RXPTRUPD_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, RXPTRUPD_AW>;
...
pub type TXPTRUPD_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, TXPTRUPD_AW>;
