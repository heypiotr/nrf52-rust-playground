...
pub type SWIDTH_R = crate::FieldReader<SWIDTH_A>;
#[doc = "Sample width.\n\nValue on reset: 1"]
...
impl crate::FieldSpec for SWIDTH_A {
    type Ux = u8;
}
impl SWIDTH_R {
...
pub type SWIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, SWIDTH_SPEC, 2, O, SWIDTH_A>;
