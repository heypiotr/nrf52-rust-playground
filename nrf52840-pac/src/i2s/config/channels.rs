...
pub type CHANNELS_R = crate::FieldReader<CHANNELS_A>;
#[doc = "Enable channels.\n\nValue on reset: 0"]
...
impl crate::FieldSpec for CHANNELS_A {
    type Ux = u8;
}
impl CHANNELS_R {
...
pub type CHANNELS_W<'a, const O: u8> = crate::FieldWriter<'a, CHANNELS_SPEC, 2, O, CHANNELS_A>;
