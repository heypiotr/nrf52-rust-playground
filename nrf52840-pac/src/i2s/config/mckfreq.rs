...
pub type MCKFREQ_R = crate::FieldReader<MCKFREQ_A>;
...
impl crate::FieldSpec for MCKFREQ_A {
    type Ux = u32;
}
impl MCKFREQ_R {
...
pub type MCKFREQ_W<'a, const O: u8> = crate::FieldWriter<'a, MCKFREQ_SPEC, 32, O, MCKFREQ_A>;
