...
pub type ORDER_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, ORDER_A>;
...
pub type CPHA_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, CPHA_A>;
...
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, CPOL_A>;
