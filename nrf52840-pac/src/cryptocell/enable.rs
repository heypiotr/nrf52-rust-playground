...
#[doc = "Field `ENABLE` reader - Enable or disable the CRYPTOCELL subsystem"]
...
#[doc = "Field `ENABLE` writer - Enable or disable the CRYPTOCELL subsystem"]
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, ENABLE_SPEC, O, ENABLE_A>;
...
impl R {
    #[doc = "Bit 0 - Enable or disable the CRYPTOCELL subsystem"]
    #[inline(always)]
