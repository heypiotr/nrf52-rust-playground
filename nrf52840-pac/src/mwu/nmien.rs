...
pub type REGION0WA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION0WA_A>;
...
pub type REGION0RA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION0RA_A>;
...
pub type REGION1WA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION1WA_A>;
...
pub type REGION1RA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION1RA_A>;
...
pub type REGION2WA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION2WA_A>;
...
pub type REGION2RA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION2RA_A>;
...
pub type REGION3WA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION3WA_A>;
...
pub type REGION3RA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, REGION3RA_A>;
...
pub type PREGION0WA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, PREGION0WA_A>;
...
pub type PREGION0RA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, PREGION0RA_A>;
...
pub type PREGION1WA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, PREGION1WA_A>;
...
pub type PREGION1RA_W<'a, const O: u8> = crate::BitWriter<'a, NMIEN_SPEC, O, PREGION1RA_A>;
