...
pub type RGN0WA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN0WA_AW>;
...
pub type RGN0RA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN0RA_AW>;
...
pub type RGN1WA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN1WA_AW>;
...
pub type RGN1RA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN1RA_AW>;
...
pub type RGN2WA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN2WA_AW>;
...
pub type RGN2RA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN2RA_AW>;
...
pub type RGN3WA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN3WA_AW>;
...
pub type RGN3RA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, RGN3RA_AW>;
...
pub type PRGN0WA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, PRGN0WA_AW>;
...
pub type PRGN0RA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, PRGN0RA_AW>;
...
pub type PRGN1WA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, PRGN1WA_AW>;
...
pub type PRGN1RA_W<'a, const O: u8> = crate::BitWriter<'a, REGIONENSET_SPEC, O, PRGN1RA_AW>;
