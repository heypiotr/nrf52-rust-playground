...
pub type SEQSTARTED0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, SEQSTARTED0_AW>;
...
pub type SEQSTARTED1_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, SEQSTARTED1_AW>;
...
pub type SEQEND0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, SEQEND0_AW>;
...
pub type SEQEND1_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, SEQEND1_AW>;
...
pub type PWMPERIODEND_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, PWMPERIODEND_AW>;
...
pub type LOOPSDONE_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, LOOPSDONE_AW>;
