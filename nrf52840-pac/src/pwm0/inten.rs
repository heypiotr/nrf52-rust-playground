...
pub type SEQSTARTED0_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, SEQSTARTED0_A>;
...
pub type SEQSTARTED1_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, SEQSTARTED1_A>;
...
pub type SEQEND0_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, SEQEND0_A>;
...
pub type SEQEND1_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, SEQEND1_A>;
...
pub type PWMPERIODEND_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, PWMPERIODEND_A>;
...
pub type LOOPSDONE_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, LOOPSDONE_A>;
