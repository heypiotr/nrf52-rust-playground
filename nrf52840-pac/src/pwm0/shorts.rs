...
and task STOP"]
pub type SEQEND0_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, SEQEND0_STOP_A>;
...
and task STOP"]
pub type SEQEND1_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, SEQEND1_STOP_A>;
...
pub type LOOPSDONE_SEQSTART0_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, LOOPSDONE_SEQSTART0_A>;
...
pub type LOOPSDONE_SEQSTART1_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, LOOPSDONE_SEQSTART1_A>;
...
pub type LOOPSDONE_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, LOOPSDONE_STOP_A>;
