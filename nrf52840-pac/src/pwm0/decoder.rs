...
pub type LOAD_R = crate::FieldReader<LOAD_A>;
...
impl crate::FieldSpec for LOAD_A {
    type Ux = u8;
}
impl LOAD_R {
...
pub type LOAD_W<'a, const O: u8> = crate::FieldWriterSafe<'a, DECODER_SPEC, 2, O, LOAD_A>;
...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, DECODER_SPEC, O, MODE_A>;
