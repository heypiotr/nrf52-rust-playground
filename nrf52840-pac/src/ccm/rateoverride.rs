...
pub type RATEOVERRIDE_R = crate::FieldReader<RATEOVERRIDE_A>;
...
impl crate::FieldSpec for RATEOVERRIDE_A {
    type Ux = u8;
}
impl RATEOVERRIDE_R {
...
pub type RATEOVERRIDE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, RATEOVERRIDE_SPEC, 2, O, RATEOVERRIDE_A>;
