...
#[doc = "Field `EVENTS_ERROR` reader - Deprecated field - CCM error event"]
pub type EVENTS_ERROR_R = crate::BitReader<EVENTS_ERROR_A>;
#[doc = "Deprecated field - CCM error event\n\nValue on reset: 0"]
...
#[doc = "Field `EVENTS_ERROR` writer - Deprecated field - CCM error event"]
pub type EVENTS_ERROR_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_ERROR_SPEC, O, EVENTS_ERROR_A>;
...
impl R {
    #[doc = "Bit 0 - Deprecated field - CCM error event"]
    #[inline(always)]
