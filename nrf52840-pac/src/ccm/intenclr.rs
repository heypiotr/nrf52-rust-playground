...
pub type ENDKSGEN_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ENDKSGEN_AW>;
...
pub type ENDCRYPT_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, ENDCRYPT_AW>;
