...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, CONFIG_SPEC, 2, O, MODE_A>;
...
tasks and IN\\[n\\]
event"]
pub type PSEL_W<'a, const O: u8> = crate::FieldWriter<'a, CONFIG_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O>;
...
task is triggered. When In event mode: Operation on input that shall trigger IN\\[n\\]
event."]
pub type POLARITY_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CONFIG_SPEC, 2, O, POLARITY_A>;
...
pub type OUTINIT_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, OUTINIT_A>;
...
event"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn port(&mut self) -> PORT_W<13> {
        PORT_W::new(self)
    }
    #[doc = "Bits 16:17 - When In task mode: Operation to be performed on output when OUT\\[n\\]
task is triggered. When In event mode: Operation on input that shall trigger IN\\[n\\]
