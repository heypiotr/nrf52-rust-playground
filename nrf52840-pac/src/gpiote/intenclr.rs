...
pub type IN0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN0_AW>;
...
pub type IN1_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN1_AW>;
...
pub type IN2_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN2_AW>;
...
pub type IN3_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN3_AW>;
...
pub type IN4_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN4_AW>;
...
pub type IN5_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN5_AW>;
...
pub type IN6_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN6_AW>;
...
pub type IN7_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, IN7_AW>;
...
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, PORT_AW>;
