...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, PIN_CNF_SPEC, O, DIR_A>;
...
pub type INPUT_W<'a, const O: u8> = crate::BitWriter<'a, PIN_CNF_SPEC, O, INPUT_A>;
...
pub type PULL_R = crate::FieldReader<PULL_A>;
...
impl crate::FieldSpec for PULL_A {
    type Ux = u8;
}
impl PULL_R {
    #[doc = "Get enumerated values variant"]
...
pub type PULL_W<'a, const O: u8> = crate::FieldWriter<'a, PIN_CNF_SPEC, 2, O, PULL_A>;
...
pub type DRIVE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PIN_CNF_SPEC, 3, O, DRIVE_A>;
...
pub type SENSE_R = crate::FieldReader<SENSE_A>;
...
impl crate::FieldSpec for SENSE_A {
    type Ux = u8;
}
impl SENSE_R {
    #[doc = "Get enumerated values variant"]
...
pub type SENSE_W<'a, const O: u8> = crate::FieldWriter<'a, PIN_CNF_SPEC, 2, O, SENSE_A>;
