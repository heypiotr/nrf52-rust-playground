...
pub type READY_SAMPLE_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, READY_SAMPLE_A>;
...
pub type READY_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, READY_STOP_A>;
...
pub type DOWN_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, DOWN_STOP_A>;
...
pub type UP_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, UP_STOP_A>;
...
pub type CROSS_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, CROSS_STOP_A>;
