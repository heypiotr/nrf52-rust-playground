...
pub type DOWN_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, DOWN_A>;
...
pub type UP_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, UP_A>;
...
pub type CROSS_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, CROSS_A>;
