...
#[doc = "Field `MISSES` reader - Number of cache misses. Register is writable, but only to '0'."]
pub type MISSES_R = crate::FieldReader<u32>;
#[doc = "Field `MISSES` writer - Number of cache misses. Register is writable, but only to '0'."]
pub type MISSES_W<'a, const O: u8> = crate::FieldWriter<'a, IMISS_SPEC, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - Number of cache misses. Register is writable, but only to '0'."]
    #[inline(always)]
