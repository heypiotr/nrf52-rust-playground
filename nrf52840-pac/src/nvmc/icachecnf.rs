...
pub type CACHEEN_W<'a, const O: u8> = crate::BitWriter<'a, ICACHECNF_SPEC, O, CACHEEN_A>;
...
pub type CACHEPROFEN_W<'a, const O: u8> = crate::BitWriter<'a, ICACHECNF_SPEC, O, CACHEPROFEN_A>;
