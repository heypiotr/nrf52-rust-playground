...
pub type ENDRX_STARTRX_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, ENDRX_STARTRX_A>;
...
pub type ENDRX_STOPRX_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, ENDRX_STOPRX_A>;
