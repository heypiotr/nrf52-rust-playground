...
pub type OVERRUN_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, OVERRUN_A>;
...
pub type PARITY_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, PARITY_A>;
...
pub type FRAMING_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, FRAMING_A>;
...
pub type BREAK_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, BREAK_A>;
