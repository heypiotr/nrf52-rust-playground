...
pub type CTS_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, CTS_A>;
...
pub type NCTS_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, NCTS_A>;
...
pub type RXDRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, RXDRDY_A>;
...
pub type TXDRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, TXDRDY_A>;
...
pub type RXTO_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, RXTO_A>;
...
pub type RXSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, RXSTARTED_A>;
...
pub type TXSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, TXSTARTED_A>;
...
pub type TXSTOPPED_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, TXSTOPPED_A>;
