...
pub type EVENTS_TXSTOPPED_R = crate::BitReader<EVENTS_TXSTOPPED_A>;
...
impl EVENTS_TXSTOPPED_R {
    ...
    pub fn variant(&self) -> EVENTS_TXSTOPPED_A {
        match self.bits {
            false => EVENTS_TXSTOPPED_A::NOT_GENERATED,
    ...
    pub fn is_not_generated(&self) -> bool {
        *self == EVENTS_TXSTOPPED_A::NOT_GENERATED
    }
...
pub type EVENTS_TXSTOPPED_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_TXSTOPPED_SPEC, O, EVENTS_TXSTOPPED_A>;
impl<'a, const O: u8> EVENTS_TXSTOPPED_W<'a, O> {
    #[doc = "Event not generated"]
    #[inline(always)]
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_TXSTOPPED_A::NOT_GENERATED)
    }
    #[doc = "Event generated"]
    #[inline(always)]
...
impl R {
    ...
    pub fn events_txstopped(&self) -> EVENTS_TXSTOPPED_R {
        EVENTS_TXSTOPPED_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Transmitter stopped"]
    #[inline(always)]
    #[must_use]
    pub fn events_txstopped(&mut self) -> EVENTS_TXSTOPPED_W<0> {
        EVENTS_TXSTOPPED_W::new(self)
    }
