...
pub type BAUDRATE_R = crate::FieldReader<BAUDRATE_A>;
...
impl crate::FieldSpec for BAUDRATE_A {
    type Ux = u32;
}
impl BAUDRATE_R {
...
pub type BAUDRATE_W<'a, const O: u8> = crate::FieldWriter<'a, BAUDRATE_SPEC, 32, O, BAUDRATE_A>;
