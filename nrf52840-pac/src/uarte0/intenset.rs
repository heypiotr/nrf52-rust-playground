...
pub type CTS_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, CTS_AW>;
...
pub type NCTS_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, NCTS_AW>;
...
pub type RXDRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, RXDRDY_AW>;
...
pub type TXDRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, TXDRDY_AW>;
...
pub type RXTO_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, RXTO_AW>;
...
pub type RXSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, RXSTARTED_AW>;
...
pub type TXSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, TXSTARTED_AW>;
...
pub type TXSTOPPED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, TXSTOPPED_AW>;
