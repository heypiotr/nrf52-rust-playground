...
pub type ANACK_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, ANACK_A>;
impl<'a, const O: u8> ANACK_W<'a, O> {
    #[doc = "Read: error not present"]
    #[inline(always)]
    pub fn not_present(self) -> &'a mut W {
        self.variant(ANACK_A::NOT_PRESENT)
    }
...
pub type DNACK_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, DNACK_A>;
impl<'a, const O: u8> DNACK_W<'a, O> {
    #[doc = "Read: error not present"]
    #[inline(always)]
    pub fn not_present(self) -> &'a mut W {
        self.variant(DNACK_A::NOT_PRESENT)
    }
    #[doc = "Read: error present"]
    #[inline(always)]
    pub fn present(self) -> &'a mut W {
