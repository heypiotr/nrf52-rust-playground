...
pub type RXDREADY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, RXDREADY_AW>;
...
pub type TXDSENT_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, TXDSENT_AW>;
...
pub type BB_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, BB_AW>;
