...
pub type BB_SUSPEND_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, BB_SUSPEND_A>;
...
pub type BB_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, BB_STOP_A>;
