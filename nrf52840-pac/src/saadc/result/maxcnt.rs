...
#[doc = "Field `MAXCNT` reader - Maximum number of 16-bit samples to be written to output RAM buffer"]
pub type MAXCNT_R = crate::FieldReader<u16>;
#[doc = "Field `MAXCNT` writer - Maximum number of 16-bit samples to be written to output RAM buffer"]
pub type MAXCNT_W<'a, const O: u8> = crate::FieldWriter<'a, MAXCNT_SPEC, 15, O, u16>;
impl R {
    #[doc = "Bits 0:14 - Maximum number of 16-bit samples to be written to output RAM buffer"]
    #[inline(always)]
    pub fn maxcnt(&self) -> MAXCNT_R {
        MAXCNT_R::new((self.bits & 0x7fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:14 - Maximum number of 16-bit samples to be written to output RAM buffer"]
