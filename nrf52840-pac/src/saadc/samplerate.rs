...
pub type CC_R = crate::FieldReader<u16>;
#[doc = "Field `CC` writer - Capture and compare value. Sample rate is 16 MHz/CC"]
pub type CC_W<'a, const O: u8> = crate::FieldWriter<'a, SAMPLERATE_SPEC, 11, O, u16>;
...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLERATE_SPEC, O, MODE_A>;
