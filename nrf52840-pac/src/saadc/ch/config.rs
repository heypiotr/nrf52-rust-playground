...
pub type RESP_R = crate::FieldReader<RESP_A>;
...
impl crate::FieldSpec for RESP_A {
    type Ux = u8;
}
impl RESP_R {
...
pub type RESP_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CONFIG_SPEC, 2, O, RESP_A>;
...
pub type RESN_R = crate::FieldReader<RESN_A>;
...
impl crate::FieldSpec for RESN_A {
    type Ux = u8;
}
impl RESN_R {
    #[doc = "Get enumerated values variant"]
...
pub type RESN_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CONFIG_SPEC, 2, O, RESN_A>;
...
pub type GAIN_R = crate::FieldReader<GAIN_A>;
#[doc = "Gain control\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum GAIN_A {
...
impl crate::FieldSpec for GAIN_A {
    type Ux = u8;
}
impl GAIN_R {
    #[doc = "Get enumerated values variant"]
...
pub type GAIN_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CONFIG_SPEC, 3, O, GAIN_A>;
...
pub type REFSEL_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, REFSEL_A>;
...
pub type TACQ_R = crate::FieldReader<TACQ_A>;
...
impl crate::FieldSpec for TACQ_A {
    type Ux = u8;
}
impl TACQ_R {
    #[doc = "Get enumerated values variant"]
...
pub type TACQ_W<'a, const O: u8> = crate::FieldWriter<'a, CONFIG_SPEC, 3, O, TACQ_A>;
...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, MODE_A>;
...
pub type BURST_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, BURST_A>;
