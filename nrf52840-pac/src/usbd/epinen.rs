...
pub type IN0_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN0_A>;
...
pub type IN1_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN1_A>;
...
pub type IN2_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN2_A>;
...
pub type IN3_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN3_A>;
...
pub type IN4_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN4_A>;
...
pub type IN5_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN5_A>;
...
pub type IN6_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN6_A>;
...
pub type IN7_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, IN7_A>;
...
pub type ISOIN_W<'a, const O: u8> = crate::BitWriter<'a, EPINEN_SPEC, O, ISOIN_A>;
