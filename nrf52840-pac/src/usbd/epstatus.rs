...
pub type EPIN0_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN0_A>;
...
pub type EPIN1_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN1_A>;
...
pub type EPIN2_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN2_A>;
...
pub type EPIN3_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN3_A>;
...
pub type EPIN4_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN4_A>;
...
pub type EPIN5_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN5_A>;
...
pub type EPIN6_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN6_A>;
...
pub type EPIN7_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN7_A>;
...
pub type EPIN8_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPIN8_A>;
...
pub type EPOUT0_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT0_A>;
...
pub type EPOUT1_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT1_A>;
...
pub type EPOUT2_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT2_A>;
...
pub type EPOUT3_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT3_A>;
...
pub type EPOUT4_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT4_A>;
...
pub type EPOUT5_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT5_A>;
...
pub type EPOUT6_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT6_A>;
...
pub type EPOUT7_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT7_A>;
...
pub type EPOUT8_W<'a, const O: u8> = crate::BitWriter1C<'a, EPSTATUS_SPEC, O, EPOUT8_A>;
...
impl crate::Writable for EPSTATUS_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x01ff_01ff;
}
