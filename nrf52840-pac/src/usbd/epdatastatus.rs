...
pub type EPIN1_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPIN1_A>;
...
pub type EPIN2_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPIN2_A>;
...
pub type EPIN3_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPIN3_A>;
...
pub type EPIN4_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPIN4_A>;
...
pub type EPIN5_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPIN5_A>;
...
pub type EPIN6_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPIN6_A>;
...
pub type EPIN7_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPIN7_A>;
...
pub type EPOUT1_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPOUT1_A>;
...
pub type EPOUT2_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPOUT2_A>;
...
pub type EPOUT3_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPOUT3_A>;
...
pub type EPOUT4_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPOUT4_A>;
...
pub type EPOUT5_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPOUT5_A>;
...
pub type EPOUT6_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPOUT6_A>;
...
pub type EPOUT7_W<'a, const O: u8> = crate::BitWriter1C<'a, EPDATASTATUS_SPEC, O, EPOUT7_A>;
...
impl crate::Writable for EPDATASTATUS_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x00fe_00fe;
}
