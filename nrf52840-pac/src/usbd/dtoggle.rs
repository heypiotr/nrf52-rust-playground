...
pub type EP_R = crate::FieldReader;
#[doc = "Field `EP` writer - Select bulk endpoint number"]
pub type EP_W<'a, const O: u8> = crate::FieldWriter<'a, DTOGGLE_SPEC, 3, O>;
...
pub type IO_W<'a, const O: u8> = crate::BitWriter<'a, DTOGGLE_SPEC, O, IO_A>;
...
pub type VALUE_R = crate::FieldReader<VALUE_A>;
...
impl crate::FieldSpec for VALUE_A {
    type Ux = u8;
}
impl VALUE_R {
    #[doc = "Get enumerated values variant"]
...
pub type VALUE_W<'a, const O: u8> = crate::FieldWriter<'a, DTOGGLE_SPEC, 2, O, VALUE_A>;
