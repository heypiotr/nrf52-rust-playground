...
pub type OUT0_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT0_A>;
...
pub type OUT1_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT1_A>;
...
pub type OUT2_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT2_A>;
...
pub type OUT3_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT3_A>;
...
pub type OUT4_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT4_A>;
...
pub type OUT5_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT5_A>;
...
pub type OUT6_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT6_A>;
...
pub type OUT7_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, OUT7_A>;
...
pub type ISOOUT_W<'a, const O: u8> = crate::BitWriter<'a, EPOUTEN_SPEC, O, ISOOUT_A>;
