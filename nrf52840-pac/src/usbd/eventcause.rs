...
pub type ISOOUTCRC_W<'a, const O: u8> = crate::BitWriter1C<'a, EVENTCAUSE_SPEC, O, ISOOUTCRC_A>;
...
pub type SUSPEND_W<'a, const O: u8> = crate::BitWriter1C<'a, EVENTCAUSE_SPEC, O, SUSPEND_A>;
...
pub type RESUME_W<'a, const O: u8> = crate::BitWriter1C<'a, EVENTCAUSE_SPEC, O, RESUME_A>;
...
pub type USBWUALLOWED_W<'a, const O: u8> =
    crate::BitWriter1C<'a, EVENTCAUSE_SPEC, O, USBWUALLOWED_A>;
...
pub type READY_W<'a, const O: u8> = crate::BitWriter1C<'a, EVENTCAUSE_SPEC, O, READY_A>;
...
impl crate::Writable for EVENTCAUSE_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x0f01;
}
