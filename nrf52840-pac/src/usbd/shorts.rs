...
pub type EP0DATADONE_STARTEPIN0_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, EP0DATADONE_STARTEPIN0_A>;
...
pub type EP0DATADONE_STARTEPOUT0_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, EP0DATADONE_STARTEPOUT0_A>;
...
pub type EP0DATADONE_EP0STATUS_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, EP0DATADONE_EP0STATUS_A>;
...
pub type ENDEPOUT0_EP0STATUS_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, ENDEPOUT0_EP0STATUS_A>;
...
pub type ENDEPOUT0_EP0RCVOUT_W<'a, const O: u8> =
    crate::BitWriter<'a, SHORTS_SPEC, O, ENDEPOUT0_EP0RCVOUT_A>;
