...
pub type EP_W<'a, const O: u8> = crate::FieldWriter<'a, EPSTALL_SPEC, 3, O>;
...
pub type IO_W<'a, const O: u8> = crate::BitWriter<'a, EPSTALL_SPEC, O, IO_AW>;
...
pub type STALL_W<'a, const O: u8> = crate::BitWriter<'a, EPSTALL_SPEC, O, STALL_AW>;
