...
pub type EVENTS_CCABUSY_R = crate::BitReader<EVENTS_CCABUSY_A>;
...
impl EVENTS_CCABUSY_R {
    ...
    pub fn variant(&self) -> EVENTS_CCABUSY_A {
        match self.bits {
            false => EVENTS_CCABUSY_A::NOT_GENERATED,
    ...
    pub fn is_not_generated(&self) -> bool {
        *self == EVENTS_CCABUSY_A::NOT_GENERATED
    }
...
pub type EVENTS_CCABUSY_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_CCABUSY_SPEC, O, EVENTS_CCABUSY_A>;
impl<'a, const O: u8> EVENTS_CCABUSY_W<'a, O> {
    #[doc = "Event not generated"]
    #[inline(always)]
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_CCABUSY_A::NOT_GENERATED)
    }
    #[doc = "Event generated"]
    #[inline(always)]
