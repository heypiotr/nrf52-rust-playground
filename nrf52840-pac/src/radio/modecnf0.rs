...
pub type RU_W<'a, const O: u8> = crate::BitWriter<'a, MODECNF0_SPEC, O, RU_A>;
...
pub type DTX_R = crate::FieldReader<DTX_A>;
...
impl crate::FieldSpec for DTX_A {
    type Ux = u8;
}
impl DTX_R {
    #[doc = "Get enumerated values variant"]
...
pub type DTX_W<'a, const O: u8> = crate::FieldWriter<'a, MODECNF0_SPEC, 2, O, DTX_A>;
