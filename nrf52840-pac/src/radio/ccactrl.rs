...
pub type CCAMODE_R = crate::FieldReader<CCAMODE_A>;
...
impl crate::FieldSpec for CCAMODE_A {
    type Ux = u8;
}
impl CCAMODE_R {
...
pub type CCAMODE_W<'a, const O: u8> = crate::FieldWriter<'a, CCACTRL_SPEC, 3, O, CCAMODE_A>;
...
pub type CCAEDTHRES_R = crate::FieldReader;
#[doc = "Field `CCAEDTHRES` writer - CCA energy busy threshold. Used in all the CCA modes except CarrierMode."]
pub type CCAEDTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, CCACTRL_SPEC, 8, O>;
...
pub type CCACORRTHRES_R = crate::FieldReader;
...
pub type CCACORRTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, CCACTRL_SPEC, 8, O>;
...
pub type CCACORRCNT_R = crate::FieldReader;
...
pub type CCACORRCNT_W<'a, const O: u8> = crate::FieldWriter<'a, CCACTRL_SPEC, 8, O>;
impl R {
...
impl crate::Resettable for CCACTRL_SPEC {
    const RESET_VALUE: Self::Ux = 0x052d_0000;
}
