...
pub type LEN_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CRCCNF_SPEC, 2, O, LEN_A>;
...
pub type SKIPADDR_R = crate::FieldReader<SKIPADDR_A>;
...
impl crate::FieldSpec for SKIPADDR_A {
    type Ux = u8;
}
impl SKIPADDR_R {
    #[doc = "Get enumerated values variant"]
...
pub type SKIPADDR_W<'a, const O: u8> = crate::FieldWriter<'a, CRCCNF_SPEC, 2, O, SKIPADDR_A>;
...
impl R {
    ...
    pub fn skipaddr(&self) -> SKIPADDR_R {
        SKIPADDR_R::new(((self.bits >> 8) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - CRC length in number of bytes."]
