...
pub type ADDR0_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR0_A>;
...
pub type ADDR1_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR1_A>;
...
pub type ADDR2_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR2_A>;
...
pub type ADDR3_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR3_A>;
...
pub type ADDR4_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR4_A>;
...
pub type ADDR5_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR5_A>;
...
pub type ADDR6_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR6_A>;
...
pub type ADDR7_W<'a, const O: u8> = crate::BitWriter<'a, RXADDRESSES_SPEC, O, ADDR7_A>;
