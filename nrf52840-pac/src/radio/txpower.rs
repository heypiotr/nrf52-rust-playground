...
pub type TXPOWER_R = crate::FieldReader<TXPOWER_A>;
...
impl crate::FieldSpec for TXPOWER_A {
    type Ux = u8;
}
impl TXPOWER_R {
...
pub type TXPOWER_W<'a, const O: u8> = crate::FieldWriter<'a, TXPOWER_SPEC, 8, O, TXPOWER_A>;
