...
pub type MAXLEN_R = crate::FieldReader;
...
pub type MAXLEN_W<'a, const O: u8> = crate::FieldWriter<'a, PCNF1_SPEC, 8, O>;
#[doc = "Field `STATLEN` reader - Static length in number of bytes"]
pub type STATLEN_R = crate::FieldReader;
#[doc = "Field `STATLEN` writer - Static length in number of bytes"]
pub type STATLEN_W<'a, const O: u8> = crate::FieldWriter<'a, PCNF1_SPEC, 8, O>;
#[doc = "Field `BALEN` reader - Base address length in number of bytes"]
pub type BALEN_R = crate::FieldReader;
#[doc = "Field `BALEN` writer - Base address length in number of bytes"]
pub type BALEN_W<'a, const O: u8> = crate::FieldWriter<'a, PCNF1_SPEC, 3, O>;
...
pub type ENDIAN_W<'a, const O: u8> = crate::BitWriter<'a, PCNF1_SPEC, O, ENDIAN_A>;
...
pub type WHITEEN_W<'a, const O: u8> = crate::BitWriter<'a, PCNF1_SPEC, O, WHITEEN_A>;
