...
pub type EVENTS_DEVMATCH_R = crate::BitReader<EVENTS_DEVMATCH_A>;
...
impl EVENTS_DEVMATCH_R {
    ...
    pub fn variant(&self) -> EVENTS_DEVMATCH_A {
        match self.bits {
            false => EVENTS_DEVMATCH_A::NOT_GENERATED,
    ...
    pub fn is_not_generated(&self) -> bool {
        *self == EVENTS_DEVMATCH_A::NOT_GENERATED
    }
...
pub type EVENTS_DEVMATCH_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_DEVMATCH_SPEC, O, EVENTS_DEVMATCH_A>;
impl<'a, const O: u8> EVENTS_DEVMATCH_W<'a, O> {
    #[doc = "Event not generated"]
    #[inline(always)]
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_DEVMATCH_A::NOT_GENERATED)
    }
    #[doc = "Event generated"]
    #[inline(always)]
