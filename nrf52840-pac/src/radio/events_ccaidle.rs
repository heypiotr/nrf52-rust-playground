...
pub type EVENTS_CCAIDLE_R = crate::BitReader<EVENTS_CCAIDLE_A>;
...
impl EVENTS_CCAIDLE_R {
    ...
    pub fn variant(&self) -> EVENTS_CCAIDLE_A {
        match self.bits {
            false => EVENTS_CCAIDLE_A::NOT_GENERATED,
    ...
    pub fn is_not_generated(&self) -> bool {
        *self == EVENTS_CCAIDLE_A::NOT_GENERATED
    }
...
pub type EVENTS_CCAIDLE_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_CCAIDLE_SPEC, O, EVENTS_CCAIDLE_A>;
impl<'a, const O: u8> EVENTS_CCAIDLE_W<'a, O> {
    #[doc = "Event not generated"]
    #[inline(always)]
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_CCAIDLE_A::NOT_GENERATED)
    }
    #[doc = "Event generated"]
    #[inline(always)]
...
impl R {
    ...
    pub fn events_ccaidle(&self) -> EVENTS_CCAIDLE_R {
        EVENTS_CCAIDLE_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Wireless medium in idle - clear to send"]
    #[inline(always)]
    #[must_use]
    pub fn events_ccaidle(&mut self) -> EVENTS_CCAIDLE_W<0> {
        EVENTS_CCAIDLE_W::new(self)
    }
