...
#[doc = "Field `EVENTS_READY` reader - RADIO has ramped up and is ready to be started"]
...
#[doc = "Field `EVENTS_READY` writer - RADIO has ramped up and is ready to be started"]
