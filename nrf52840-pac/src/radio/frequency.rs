...
pub type FREQUENCY_R = crate::FieldReader;
#[doc = "Field `FREQUENCY` writer - Radio channel frequency"]
pub type FREQUENCY_W<'a, const O: u8> = crate::FieldWriter<'a, FREQUENCY_SPEC, 7, O>;
...
pub type MAP_W<'a, const O: u8> = crate::BitWriter<'a, FREQUENCY_SPEC, O, MAP_A>;
