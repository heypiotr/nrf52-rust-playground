...
pub struct R(crate::R<IO1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IO1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IO1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IO1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IO1` writer"]
pub struct W(crate::W<IO1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IO1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IO1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IO1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, IO1_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, IO1_SPEC, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, IO1_SPEC, O, CONNECT_A>;
