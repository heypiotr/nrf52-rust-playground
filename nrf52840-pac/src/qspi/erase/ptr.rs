...
#[doc = "Field `PTR` reader - Word-aligned start address of block to be erased."]
pub type PTR_R = crate::FieldReader<u32>;
#[doc = "Field `PTR` writer - Word-aligned start address of block to be erased."]
pub type PTR_W<'a, const O: u8> = crate::FieldWriter<'a, PTR_SPEC, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - Word-aligned start address of block to be erased."]
    #[inline(always)]
