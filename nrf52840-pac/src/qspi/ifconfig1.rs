...
pub type SCKDELAY_R = crate::FieldReader;
...
pub type SCKDELAY_W<'a, const O: u8> = crate::FieldWriter<'a, IFCONFIG1_SPEC, 8, O>;
...
pub type DPMEN_W<'a, const O: u8> = crate::BitWriter<'a, IFCONFIG1_SPEC, O, DPMEN_A>;
...
pub type SPIMODE_W<'a, const O: u8> = crate::BitWriter<'a, IFCONFIG1_SPEC, O, SPIMODE_A>;
...
pub type SCKFREQ_R = crate::FieldReader;
#[doc = "Field `SCKFREQ` writer - SCK frequency is given as 32 MHz / (SCKFREQ + 1)."]
pub type SCKFREQ_W<'a, const O: u8> = crate::FieldWriter<'a, IFCONFIG1_SPEC, 4, O>;
impl R {
...
impl crate::Resettable for IFCONFIG1_SPEC {
    const RESET_VALUE: Self::Ux = 0x0004_0480;
}
