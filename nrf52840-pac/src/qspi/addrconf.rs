...
pub type OPCODE_W<'a, const O: u8> = crate::FieldWriter<'a, ADDRCONF_SPEC, 8, O>;
...
pub type BYTE0_W<'a, const O: u8> = crate::FieldWriter<'a, ADDRCONF_SPEC, 8, O>;
...
pub type BYTE1_W<'a, const O: u8> = crate::FieldWriter<'a, ADDRCONF_SPEC, 8, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADDRCONF_SPEC, 2, O, MODE_A>;
...
pub type WIPWAIT_W<'a, const O: u8> = crate::BitWriter<'a, ADDRCONF_SPEC, O, WIPWAIT_A>;
...
pub type WREN_W<'a, const O: u8> = crate::BitWriter<'a, ADDRCONF_SPEC, O, WREN_A>;
...
impl crate::Resettable for ADDRCONF_SPEC {
    const RESET_VALUE: Self::Ux = 0xb7;
}
