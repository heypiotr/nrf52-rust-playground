...
#[doc = "Field `EVENTS_READY` reader - QSPI peripheral is ready. This event will be generated as a response to any QSPI task."]
...
#[doc = "Field `EVENTS_READY` writer - QSPI peripheral is ready. This event will be generated as a response to any QSPI task."]
pub type EVENTS_READY_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_READY_SPEC, O, EVENTS_READY_A>;
...
impl R {
    #[doc = "Bit 0 - QSPI peripheral is ready. This event will be generated as a response to any QSPI task."]
    #[inline(always)]
