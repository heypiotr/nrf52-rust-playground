...
pub type RESOLVED_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, RESOLVED_AW>;
...
pub type NOTRESOLVED_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, NOTRESOLVED_AW>;
