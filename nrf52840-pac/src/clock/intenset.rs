...
pub type HFCLKSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, HFCLKSTARTED_AW>;
...
pub type LFCLKSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, LFCLKSTARTED_AW>;
...
pub type CTTO_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, CTTO_AW>;
...
pub type CTSTARTED_R = crate::BitReader<CTSTARTED_A>;
...
pub type CTSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, CTSTARTED_AW>;
impl<'a, const O: u8> CTSTARTED_W<'a, O> {
    #[doc = "Enable"]
    #[inline(always)]
    pub fn set(self) -> &'a mut W {
...
pub type CTSTOPPED_R = crate::BitReader<CTSTOPPED_A>;
...
pub type CTSTOPPED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, CTSTOPPED_AW>;
impl<'a, const O: u8> CTSTOPPED_W<'a, O> {
    #[doc = "Enable"]
    #[inline(always)]
    pub fn set(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ctstarted(&mut self) -> CTSTARTED_W<10> {
        CTSTARTED_W::new(self)
    }
    #[doc = "Bit 11 - Write '1' to enable interrupt for event CTSTOPPED"]
    #[inline(always)]
    #[must_use]
    pub fn ctstopped(&mut self) -> CTSTOPPED_W<11> {
        CTSTOPPED_W::new(self)
    }
