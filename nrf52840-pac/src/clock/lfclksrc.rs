...
pub type SRC_W<'a, const O: u8> = crate::FieldWriter<'a, LFCLKSRC_SPEC, 2, O, SRC_A>;
...
pub type BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, LFCLKSRC_SPEC, O, BYPASS_A>;
...
pub type EXTERNAL_W<'a, const O: u8> = crate::BitWriter<'a, LFCLKSRC_SPEC, O, EXTERNAL_A>;
