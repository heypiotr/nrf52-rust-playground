...
pub type HFCLKSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, HFCLKSTARTED_AW>;
...
pub type LFCLKSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, LFCLKSTARTED_AW>;
...
pub type CTTO_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, CTTO_AW>;
...
pub type CTSTARTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, CTSTARTED_AW>;
...
pub type CTSTOPPED_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, CTSTOPPED_AW>;
