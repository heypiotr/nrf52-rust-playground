...
#[doc = "Field `EVENTS_DONE` reader - Calibration of LFRC completed"]
...
#[doc = "Field `EVENTS_DONE` writer - Calibration of LFRC completed"]
pub type EVENTS_DONE_W<'a, const O: u8> = crate::BitWriter<'a, EVENTS_DONE_SPEC, O, EVENTS_DONE_A>;
