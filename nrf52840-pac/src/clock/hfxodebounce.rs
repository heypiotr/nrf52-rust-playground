...
pub type HFXODEBOUNCE_R = crate::FieldReader<HFXODEBOUNCE_A>;
...
impl crate::FieldSpec for HFXODEBOUNCE_A {
    type Ux = u8;
}
impl HFXODEBOUNCE_R {
...
pub type HFXODEBOUNCE_W<'a, const O: u8> =
    crate::FieldWriter<'a, HFXODEBOUNCE_SPEC, 8, O, HFXODEBOUNCE_A>;
