...
pub type RESETPIN_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, RESETPIN_A>;
...
pub type DOG_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, DOG_A>;
...
pub type SREQ_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, SREQ_A>;
...
pub type LOCKUP_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, LOCKUP_A>;
...
pub type OFF_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, OFF_A>;
...
pub type LPCOMP_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, LPCOMP_A>;
...
pub type DIF_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, DIF_A>;
...
pub type NFC_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, NFC_A>;
...
pub type VBUS_W<'a, const O: u8> = crate::BitWriter<'a, RESETREAS_SPEC, O, VBUS_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vbus(&mut self) -> VBUS_W<20> {
        VBUS_W::new(self)
    }
