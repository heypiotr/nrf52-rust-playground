...
pub type POF_W<'a, const O: u8> = crate::BitWriter<'a, POFCON_SPEC, O, POF_A>;
...
pub type THRESHOLD_R = crate::FieldReader<THRESHOLD_A>;
...
impl crate::FieldSpec for THRESHOLD_A {
    type Ux = u8;
}
impl THRESHOLD_R {
    #[doc = "Get enumerated values variant"]
...
pub type THRESHOLD_W<'a, const O: u8> = crate::FieldWriter<'a, POFCON_SPEC, 4, O, THRESHOLD_A>;
...
pub type THRESHOLDVDDH_R = crate::FieldReader<THRESHOLDVDDH_A>;
...
impl crate::FieldSpec for THRESHOLDVDDH_A {
    type Ux = u8;
}
...
pub type THRESHOLDVDDH_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, POFCON_SPEC, 4, O, THRESHOLDVDDH_A>;
