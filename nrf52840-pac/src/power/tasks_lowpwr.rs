...
pub type TASKS_LOWPWR_W<'a, const O: u8> =
    crate::BitWriter<'a, TASKS_LOWPWR_SPEC, O, TASKS_LOWPWR_AW>;
impl<'a, const O: u8> TASKS_LOWPWR_W<'a, O> {
    #[doc = "Trigger task"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tasks_lowpwr(&mut self) -> TASKS_LOWPWR_W<0> {
        TASKS_LOWPWR_W::new(self)
    }
