...
pub type POFWARN_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, POFWARN_AW>;
...
pub type SLEEPENTER_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, SLEEPENTER_AW>;
...
pub type SLEEPEXIT_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, SLEEPEXIT_AW>;
...
pub type USBDETECTED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, USBDETECTED_AW>;
...
pub type USBREMOVED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, USBREMOVED_AW>;
...
pub type USBPWRRDY_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, USBPWRRDY_AW>;
