...
pub type CPUNIDEN_R = crate::FieldReader<CPUNIDEN_A>;
...
impl crate::FieldSpec for CPUNIDEN_A {
    type Ux = u8;
}
impl CPUNIDEN_R {
...
pub type CPUNIDEN_W<'a, const O: u8> = crate::FieldWriter<'a, DEBUGCTRL_SPEC, 8, O, CPUNIDEN_A>;
...
pub type CPUFPBEN_R = crate::FieldReader<CPUFPBEN_A>;
...
impl crate::FieldSpec for CPUFPBEN_A {
    type Ux = u8;
}
impl CPUFPBEN_R {
    #[doc = "Get enumerated values variant"]
...
pub type CPUFPBEN_W<'a, const O: u8> = crate::FieldWriter<'a, DEBUGCTRL_SPEC, 8, O, CPUFPBEN_A>;
