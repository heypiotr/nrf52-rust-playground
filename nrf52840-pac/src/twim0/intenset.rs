...
pub type SUSPENDED_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, SUSPENDED_AW>;
...
pub type LASTRX_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, LASTRX_AW>;
...
pub type LASTTX_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, LASTTX_AW>;
