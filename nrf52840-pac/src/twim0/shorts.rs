...
pub type LASTTX_STARTRX_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, LASTTX_STARTRX_A>;
...
pub type LASTTX_SUSPEND_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, LASTTX_SUSPEND_A>;
...
pub type LASTTX_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, LASTTX_STOP_A>;
...
pub type LASTRX_STARTTX_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, LASTRX_STARTTX_A>;
...
pub type LASTRX_SUSPEND_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, LASTRX_SUSPEND_A>;
...
pub type LASTRX_STOP_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, LASTRX_STOP_A>;
