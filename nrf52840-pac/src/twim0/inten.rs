...
pub type SUSPENDED_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, SUSPENDED_A>;
...
pub type LASTRX_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, LASTRX_A>;
...
pub type LASTTX_W<'a, const O: u8> = crate::BitWriter<'a, INTEN_SPEC, O, LASTTX_A>;
