...
pub type ANADETECT_R = crate::FieldReader<ANADETECT_A>;
...
impl crate::FieldSpec for ANADETECT_A {
    type Ux = u8;
}
impl ANADETECT_R {
...
pub type ANADETECT_W<'a, const O: u8> = crate::FieldWriter<'a, ANADETECT_SPEC, 2, O, ANADETECT_A>;
