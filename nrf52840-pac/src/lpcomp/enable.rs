...
#[doc = "Field `ENABLE` reader - Enable or disable LPCOMP"]
...
#[doc = "Field `ENABLE` writer - Enable or disable LPCOMP"]
pub type ENABLE_W<'a, const O: u8> = crate::FieldWriter<'a, ENABLE_SPEC, 2, O, ENABLE_A>;
