...
pub type DOWN_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, DOWN_AW>;
...
pub type UP_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, UP_AW>;
...
pub type CROSS_W<'a, const O: u8> = crate::BitWriter<'a, INTENSET_SPEC, O, CROSS_AW>;
