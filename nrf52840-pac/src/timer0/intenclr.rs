...
pub type COMPARE0_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, COMPARE0_AW>;
...
pub type COMPARE1_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, COMPARE1_AW>;
...
pub type COMPARE2_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, COMPARE2_AW>;
...
pub type COMPARE3_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, COMPARE3_AW>;
...
pub type COMPARE4_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, COMPARE4_AW>;
...
pub type COMPARE5_W<'a, const O: u8> = crate::BitWriter<'a, INTENCLR_SPEC, O, COMPARE5_AW>;
