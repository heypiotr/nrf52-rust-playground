...
pub type BITMODE_R = crate::FieldReader<BITMODE_A>;
#[doc = "Timer bit width\n\nValue on reset: 0"]
...
impl crate::FieldSpec for BITMODE_A {
    type Ux = u8;
}
impl BITMODE_R {
...
pub type BITMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BITMODE_SPEC, 2, O, BITMODE_A>;
