...
pub type LIST_R = crate::FieldReader<LIST_A>;
#[doc = "List type\n\nValue on reset: 0"]
...
impl crate::FieldSpec for LIST_A {
    type Ux = u8;
}
impl LIST_R {
...
pub type LIST_W<'a, const O: u8> = crate::FieldWriter<'a, LIST_SPEC, 2, O, LIST_A>;
