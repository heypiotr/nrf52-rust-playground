...
pub type ADDRESS0_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, ADDRESS0_A>;
...
pub type ADDRESS1_W<'a, const O: u8> = crate::BitWriter<'a, CONFIG_SPEC, O, ADDRESS1_A>;
