...
pub type OVERFLOW_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, OVERFLOW_A>;
...
pub type OVERREAD_W<'a, const O: u8> = crate::BitWriter1C<'a, ERRORSRC_SPEC, O, OVERREAD_A>;
