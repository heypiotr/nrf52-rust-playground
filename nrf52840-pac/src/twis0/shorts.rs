...
pub type WRITE_SUSPEND_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, WRITE_SUSPEND_A>;
...
pub type READ_SUSPEND_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, READ_SUSPEND_A>;
