...
pub type LCS_R = crate::FieldReader<LCS_A>;
...
impl crate::FieldSpec for LCS_A {
    type Ux = u8;
}
impl LCS_R {
...
pub type LCS_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_IOT_LCS_SPEC, 3, O, LCS_A>;
...
pub type LCS_IS_VALID_W<'a, const O: u8> =
    crate::BitWriter<'a, HOST_IOT_LCS_SPEC, O, LCS_IS_VALID_A>;
