...
pub type HOST_CRYPTOKEY_SEL_R = crate::FieldReader<HOST_CRYPTOKEY_SEL_A>;
...
impl crate::FieldSpec for HOST_CRYPTOKEY_SEL_A {
    type Ux = u8;
}
...
pub type HOST_CRYPTOKEY_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, HOST_CRYPTOKEY_SEL_SPEC, 2, O, HOST_CRYPTOKEY_SEL_A>;
