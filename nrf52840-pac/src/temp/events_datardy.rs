...
pub type EVENTS_DATARDY_R = crate::BitReader<EVENTS_DATARDY_A>;
...
impl EVENTS_DATARDY_R {
    ...
    pub fn variant(&self) -> EVENTS_DATARDY_A {
        match self.bits {
            false => EVENTS_DATARDY_A::NOT_GENERATED,
    ...
    pub fn is_not_generated(&self) -> bool {
        *self == EVENTS_DATARDY_A::NOT_GENERATED
    }
...
pub type EVENTS_DATARDY_W<'a, const O: u8> =
    crate::BitWriter<'a, EVENTS_DATARDY_SPEC, O, EVENTS_DATARDY_A>;
impl<'a, const O: u8> EVENTS_DATARDY_W<'a, O> {
    #[doc = "Event not generated"]
    #[inline(always)]
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_DATARDY_A::NOT_GENERATED)
    }
    #[doc = "Event generated"]
    #[inline(always)]
...
impl R {
    ...
    pub fn events_datardy(&self) -> EVENTS_DATARDY_R {
        EVENTS_DATARDY_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Temperature measurement complete, data ready"]
    #[inline(always)]
    #[must_use]
    pub fn events_datardy(&mut self) -> EVENTS_DATARDY_W<0> {
        EVENTS_DATARDY_W::new(self)
    }
