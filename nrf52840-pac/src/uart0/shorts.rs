...
pub type CTS_STARTRX_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, CTS_STARTRX_A>;
...
pub type NCTS_STOPRX_W<'a, const O: u8> = crate::BitWriter<'a, SHORTS_SPEC, O, NCTS_STOPRX_A>;
