#[doc = "Register `CSN` reader"]
pub struct R(crate::R<CSN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CSN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CSN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CSN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CSN` writer"]
pub struct W(crate::W<CSN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CSN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CSN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CSN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, CSN_SPEC, 5, O>;
#[doc = "Field `PORT` reader - Port number"]
pub type PORT_R = crate::BitReader;
#[doc = "Field `PORT` writer - Port number"]
pub type PORT_W<'a, const O: u8> = crate::BitWriter<'a, CSN_SPEC, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, CSN_SPEC, O, CONNECT_A>;
...
#[doc = "Pin select for CSN signal\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [csn](index.html) module"]
pub struct CSN_SPEC;
impl crate::RegisterSpec for CSN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [csn::R](R) reader structure"]
impl crate::Readable for CSN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [csn::W](W) writer structure"]
impl crate::Writable for CSN_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CSN to value 0xffff_ffff"]
impl crate::Resettable for CSN_SPEC {
