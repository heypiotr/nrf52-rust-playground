...
pub type OVERREAD_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O, OVERREAD_AW>;
...
pub type OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, STATUS_SPEC, O, OVERFLOW_AW>;
