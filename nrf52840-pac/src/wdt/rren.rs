...
register"]
pub type RR0_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR0_A>;
...
register"]
pub type RR1_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR1_A>;
...
register"]
pub type RR2_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR2_A>;
...
register"]
pub type RR3_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR3_A>;
...
register"]
pub type RR4_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR4_A>;
...
register"]
pub type RR5_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR5_A>;
...
register"]
pub type RR6_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR6_A>;
...
register"]
pub type RR7_W<'a, const O: u8> = crate::BitWriter<'a, RREN_SPEC, O, RR7_A>;
