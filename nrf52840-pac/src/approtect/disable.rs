...
pub type DISABLE_R = crate::FieldReader<DISABLE_A>;
...
impl crate::FieldSpec for DISABLE_A {
    type Ux = u8;
}
impl DISABLE_R {
...
pub type DISABLE_W<'a, const O: u8> = crate::FieldWriter<'a, DISABLE_SPEC, 8, O, DISABLE_A>;
