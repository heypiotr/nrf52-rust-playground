...
pub type FORCEPROTECT_R = crate::FieldReader<FORCEPROTECT_A>;
...
impl crate::FieldSpec for FORCEPROTECT_A {
    type Ux = u8;
}
impl FORCEPROTECT_R {
...
pub type FORCEPROTECT_W<'a, const O: u8> =
    crate::FieldWriter<'a, FORCEPROTECT_SPEC, 8, O, FORCEPROTECT_A>;
